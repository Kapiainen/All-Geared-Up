...
At the moment (version 2.0.0) the recommended way of (un)equipping weapons and shields is to use the inventory menu, the favorites menu, or the custom SkyUI group hotkeys. See the "Known issues" section for more information.
