		...
		ElseIf(asPage == Pages[1])
			...
			Else
				...
				If(iSubMenuLevel1 == 1) ;Coin purse
					...
					iOptionCoinPurseLimit1 = AddSliderOption("Stage 1", 1.0, sFormatGold)
					iOptionCoinPurseLimit2 = AddSliderOption("Stage 2", 50.0, sFormatGold)
					iOptionCoinPurseLimit3 = AddSliderOption("Stage 3", 100.0, sFormatGold)
					iOptionCoinPurseLimit4 = AddSliderOption("Stage 4", 150.0, sFormatGold)
					iOptionCoinPurseLimit5 = AddSliderOption("Stage 5", 200.0, sFormatGold)
					iOptionCoinPurseLimit6 = AddSliderOption("Stage 6", 250.0, sFormatGold)
