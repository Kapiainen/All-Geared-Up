...
public class OtherSettingsPanel extends SPSettingPanel {
	...
	AddSetting(importOnStartup);
        ...
        // daggerNode = new LComboBox("Dagger", SkyProcStarter.settingsFont, SkyProcStarter.settingsColor);
        // daggerNode = new LComboBox("Dagger");
        // daggerNode.addItem(42);
        // setPlacement(daggerNode);
        // AddSetting(daggerNode);
